...
export default function CheatingTable() {
  ...
  // Get selected exam data for PDF generation
  const selectedExamData = examsData?.find(exam => exam.examId === selectedExamId);
        ...
        <Grid container spacing={2} alignItems="center">
          ...
          <Grid item xs={12} md={4}>
            <PDFReportGenerator
              ...
              cheatingLogs={filteredUsers}
              filter={filter}
              fileName="Cheating_Report"
